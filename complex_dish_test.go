...
func TestComplexDish_CountCalories_empty(test *testing.T) {
	complexDish := ComplexDish{Dishes: []Dish{}, Part: 0.5}
...
func TestComplexDish_CountCalories_nonEmpty(test *testing.T) {
	complexDish := ComplexDish{
		Dishes: []Dish{
...
func TestComplexDish_CountMacros_nonEmpty(test *testing.T) {
	complexDish := ComplexDish{
		Dishes: []Dish{
			mockDish{
				weight: 50,
